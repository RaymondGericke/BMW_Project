### GSM MODULE SIM7600E-H 4G + GPS Antenna Module
### Sends a Tex message with current GPS Location
### GMS GPS
#!/usr/bin/python
# -*- coding:utf-8 -*-
...
phone_number = '**********' #********** change it to the phone number you want to text
try:
	power_on(power_key)
	text_message = get_gps_position()
